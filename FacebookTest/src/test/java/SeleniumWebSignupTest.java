...
public class SeleniumWebSignupTest {
    ...
    public void positiveSignup() throws InterruptedException {
        ...
        driver.findElement(By.id("user_username")).sendKeys("abass11");
        //6. Input email address on email field
        driver.findElement(By.id("user_email")).sendKeys("abassrotimi11@mailinator.com");
    ...
    public void verifyItem() throws InterruptedException {
        ...
        //Test 9. verify that the item searched for on the Megan page is present
    ...
    public void testWrongemail() throws InterruptedException {
        ...
        Thread.sleep(5000);
        //5. Input username on the username field
        driver.findElement(By.id("user_username")).sendKeys("abass7");
        //6. Input email address on email field
    ...
    public void testincompletepassword () throws InterruptedException {
        ...
        driver.findElement(By.id("user_username")).sendKeys("abass7");
        //6. Input email address on email field
        driver.findElement(By.id("user_email")).sendKeys("abass7@mailinator.com");
        //7. Locate the password field and input your password on the password field
